...
async function initializeSampleData() {
    try {
        ...
        // حفظ أنواع الشيشة في المسار المركزي
        await db.ref(`restaurant-system/restaurants/${RESTAURANT_ID}/shisha-types`).set(shishaTypes);
        console.log('✅ تم إضافة أنواع الشيشة المركزية');
