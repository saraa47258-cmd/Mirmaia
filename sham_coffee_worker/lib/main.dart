...
Future<void> main() async {
  ...
  try {
    ...
    // تهيئة Firebase REST Service (حل بديل لمشكلة platform channel)
    FirebaseRestService.initialize();
  } catch (e) {
    debugPrint('❌ Firebase initialization error: $e');
    // نستمر في تشغيل التطبيق حتى لو فشلت تهيئة Firebase
    // سيتم عرض رسالة خطأ في الشاشة
  }
